...
export default function Percentage({ data }) {
    return (
        <div className={styles.batteryPercentage}>
            <div className={styles.batteryPercentageWrapper}>
                ...
                <p className={glStyles.subHeadValue}>{data.battery.remaining.percentage}%</p>
            </div>
            <LineChart className={styles.batteryPercentageGraph} width={vw(15)} height={vh(20)} data={data.battery.remaining.data} >
