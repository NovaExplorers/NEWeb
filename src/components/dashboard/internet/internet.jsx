            ...
            <div className={styles.internetWrapper}>
                ...
                <div className={styles.connections}>
                    <div className={styles.ethernet}>
                        ...
                        <div className={styles.connectionInfo}>{data.internet.ethernet.connectedClients == 0 ? 'Disconnect' : 'Connected'}</div>
                    </div>
                    <div className={styles.wifi}>
                        ...
                        <div className={styles.connectionInfo}>{data.internet.wifi.connectedClients.length} clients connected</div>
                    </div>
                </div>
